...
#define BNO_REPORTID_UNCALIBRATED_GYRO 0x07
...
#define BNO_FRS_RECORDID_GYROSCOPE_CALIBRATED 0xE306
#define BNO_FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED 0xE309
...
#define BNO_STANDARD_INT_TIMEOUT 250
